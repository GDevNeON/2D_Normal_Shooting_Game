...
class Elite_2(Enemy):
    """
    Elite 2 is an elite mob enemy that uses dash attack like the boss.
    ...
    def __init__(self, player):
        ...
        self.dash_cooldown = 5000  # Milliseconds between dashes
        ...
        if self.sprite and len(self.sprite) > 0:
            ...
            self.size = 40  # Slightly larger for higher level elites
        ...
        if self.sprite and len(self.sprite) > 0:
            ...
            # Add visual effect for dash (red tint)
            self.dash_sprite.fill((255, 100, 100, 128), special_flags=pygame.BLEND_RGB_MULT)
    ...
    def start_dash(self, player):
        ...
        # Visual effect for dash (make sprite red tinted)
        self.dash_sprite = self.surf.copy()
        self.dash_sprite.fill((255, 100, 100, 128), special_flags=pygame.BLEND_RGB_MULT)
    ...
    def perform_dash_attack(self, player, clock):
        ...
        if dash_progress < 1.0:
            ...
            # Restore normal sprite animation on next update
