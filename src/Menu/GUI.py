...
def Run_User_Interface():
    ...
    background_selection_menu = pygame.image.load(PATH_TO_BACKGROUND_SELECTION_MENU).convert_alpha()
    ...
    button_play = Button_Text(0, 0, screen_center_x - button_width / 2, three_fourth_height - button_height / 2 - button_spacing, "Play", path_button_image, 0.4)
    button_setting = Button_Text(0, 0, screen_center_x - button_width / 2, three_fourth_height - button_height / 2, "Setting", path_button_image, 0.4)
    button_quit = Button_Text(0, 0, screen_center_x - button_width / 2, three_fourth_height - button_height / 2 + button_spacing, "Exit", path_button_image, 0.4)

    button_video_setting_menu = Button_image(470, 280, path_button_settings_video, 0.5)
    button_audio_setting_menu = Button_image(670, 280, path_button_settings_audio, 0.5)
    button_close_setting_menu = Button_image(1430, 160, path_button_settings_close, 0.1)

    button_back = Button_image(5, 5, path_button_back, 0.1)
    button_select = Button_Text(0, 0, 762.5, 810, "Select", path_button_select, 0.2)
    ...
    while running:
        ...
        if check_switch_play == True:
            screen.blit(background_selection_menu, (0, 0))
